...
(function() {
	...
	$routeProvider.when('/products', {
	    templateUrl : 'partials/products/products_business.html',
	    controller : 'ProductsController'
	}).when('/stamps', {
	    templateUrl : 'partials/products/stamps-business.html',
	    ...
	    templateUrl : 'partials/products/createProduct_business.html',
	    ...
	    templateUrl : 'partials/products/product-details_social.html',
	    controller : 'ProductDetailsController'
	}).when('/stamp-details/:stampId', {
	    templateUrl : 'partials/products/stamp-details_social.html',
	    ...
	    templateUrl : 'partials/orders/order_detail_business.html',
