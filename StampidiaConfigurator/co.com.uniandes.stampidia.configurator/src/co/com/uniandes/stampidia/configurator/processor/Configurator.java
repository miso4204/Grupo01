package co.com.uniandes.stampidia.configurator.processor;
...
import co.com.uniandes.stampidia.configurator.implementation.CloneRemoteRepository;
import co.com.uniandes.stampidia.configurator.implementation.Mapping;
import co.com.uniandes.stampidia.configurator.implementation.MavenDeploy;
import co.com.uniandes.stampidia.configurator.util.Util;


public class Configurator {
	
	public static void configuratorProcessor(String featureIDEFile, Boolean isHeroku){
		try {
			 ...
			 */
			String gui = Mapping.mapFeatureImplementation(localDeployablePath + "/stampidia",localDeployablePath + "/optional_features", featureIDEFile);
